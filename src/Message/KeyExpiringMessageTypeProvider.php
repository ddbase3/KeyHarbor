...
final class KeyExpiringMessageTypeProvider implements IMessageTypeProvider {

	public static function getName(): string {
		return 'keyharborexpiring';
	}

	public function getLabel(): string {
		return 'KeyHarbor credential expiry warning';
	}

	public function getDescription(): string {
		return 'Warns a credential owner before an API credential expires.';
	}

	public function getDefaultSubject(): string {
		return 'API credential expires soon: {{key_label}}';
	}

	public function getDefaultBodyText(): string {
		return "Hello {{user_name}},\n\n" .
			"the API credential \"{{key_label}}\" expires on {{expires_at}}.\n\n" .
	...
	public function getPlaceholders(): array {
		return [
			[
				...
				'description' => 'User-managed label of the expiring credential.',
				'required' => true,
